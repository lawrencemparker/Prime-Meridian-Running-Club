...
export default function CreateClubPage() {
  ...
  async function createClub() {
    ...
    try {
      ...
      // 3) set active club locally (keeps your existing "selected club" UX)
        ...
        <div className="mt-5 space-y-3">
          <div>
            ...
            <input
              ...
              placeholder="Run For Fun"
              autoComplete="off"
            />
          </div>

          <div className="pt-2 flex gap-3">
            <Button className="flex-1" onClick={() => void createClub()} disabled={busy}>
              {busy ? "Creating..." : "Create"}
            </Button>

            <Button className="flex-1" variant="secondary" onClick={() => router.back()} disabled={busy}>
              Back
            </Button>
          </div>
        </div>
