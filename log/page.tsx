...
import { Store, type Club } from "@/lib/mcrStore";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Minimal (no-invite-yet) club visibility model:
        // show clubs you created. Once invites are implemented, extend
        // this to include membership-based clubs.
